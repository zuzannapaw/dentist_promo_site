...
const Team = () => {
    return (
        <Box style={{ width: "100%", height: "70vh"}}>
            ...
            <Box style={{ height: "100%", paddingTop:"2%",paddingBottom:"2%",display: "flex", justifyContent: "space-around", alignItems: "center", marginTop: "-50px" }}>
                <IconButton style={{marginBottom:"3%"}}><KeyboardArrowLeftIcon style={{ fontSize: "50px"}} /></IconButton>
                <Box style={{ width: "35vh", height: "35vh", borderRadius: "50%", border: "3px solid #67C9CB", background: `url(${doctor1.image})`, backgroundPosition: "40% 5%" ,marginTop:"-8%"}}/>
                <IconButton style={{marginBottom:"5%"}}><KeyboardArrowRightIcon style={{ fontSize: "50px"}} /></IconButton>

            </Box>
            <Box style={{ height: "2%", display:"flex",flexDirection:"column", justifyContent: "space-around", alignItems: "center",marginTop:"-10%"}}>
